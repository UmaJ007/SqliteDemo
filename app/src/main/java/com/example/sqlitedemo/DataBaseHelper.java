...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_CUSTOMER_NAME = "CUSTOMER_NANE";
...
//    }
    ...
    //this is called the first time a database is accessed. There should ne code in here to create a new database.
